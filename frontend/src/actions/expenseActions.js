...
export const payExpense = (expenseId) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const deliverExpense = (expense) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    await axios.put(`/api/expenses/${expense._id}/deliver`, {}, config);
